...
> **完整的 API 变化速查见 `$SHARED_DIR/knowledge-base/frida-17x-api.md`。**
...
或使用 `disassembler/frida_unpack.py` 的内置监控机制。该脚本位于项目根目录: `$(dirname $(dirname "$SHARED_DIR"))/disassembler/frida_unpack.py`。
